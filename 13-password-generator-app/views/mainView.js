...
const strengthWarning = document.getElementById("password-strength-warning-text");
...
function displayStrengthThresholdString(string) {
    strengthWarning.textContent = string === "too weak" ? string.toUpperCase() + "!" : string.toUpperCase();
}

function fillPasswordStrengthBoxes (string) {
    const strengthBoxes = Array.from(document.querySelectorAll('.password-strength-box'));
...
export { mainViewInit, clearPassword, updateGeneratedPassword, displayStrengthThresholdString, fillPasswordStrengthBoxes };