function createGallery({ isModal }) {
  ...
  galleryMainPlusThumbnailWrapper.classList.add(
    "gallery-main-plus-thumbnail-wrapper",
  );

  const galleryMainImageContainer = document.createElement("div");
  galleryMainImageContainer.classList.add(
    "gallery-main-image-container",
    "desktop",
  );

  const mainImageContainerButton = isModal
    ? document.createElement("div")
    : document.createElement("button");
  mainImageContainerButton.classList.add(
  ...
  arrowContainerPrevious.classList.add(
    "arrow-container",
